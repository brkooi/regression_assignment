...
2. If we model the dependent variable mpg only with the predictor variable am (mpg ~ am), automatic transmission has a advantage of 7.245 miles per gallon with a standard error of 1.764 miles per gallon versus manual transmission;
